...
Version  : 25.2.5
Release  : 105
URL      : https://github.com/intel/media-driver/archive/intel-media-25.2.5/media-driver-25.2.5.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-25.2.5/media-driver-25.2.5.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-25.2.5
cd %{_builddir}/media-driver-intel-media-25.2.5
pushd ..
cp -a media-driver-intel-media-25.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750258032
mkdir -p clr-build
pushd clr-build
