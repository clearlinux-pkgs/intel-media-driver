...
Version  : 24.2.3
Release  : 85
URL      : https://github.com/intel/media-driver/archive/intel-media-24.2.3/media-driver-24.2.3.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-24.2.3/media-driver-24.2.3.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-24.2.3
cd %{_builddir}/media-driver-intel-media-24.2.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716260599
mkdir -p clr-build
pushd clr-build
