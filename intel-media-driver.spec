...
Version  : 24.2.4
Release  : 86
URL      : https://github.com/intel/media-driver/archive/intel-media-24.2.4/media-driver-24.2.4.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-24.2.4/media-driver-24.2.4.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-24.2.4
cd %{_builddir}/media-driver-intel-media-24.2.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716905887
mkdir -p clr-build
pushd clr-build
