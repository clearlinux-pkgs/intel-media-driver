...
Version  : 24.1.3
Release  : 79
URL      : https://github.com/intel/media-driver/archive/intel-media-24.1.3/media-driver-24.1.3.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-24.1.3/media-driver-24.1.3.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-24.1.3
cd %{_builddir}/media-driver-intel-media-24.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706889190
mkdir -p clr-build
pushd clr-build
