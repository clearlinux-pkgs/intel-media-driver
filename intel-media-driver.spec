...
Source0  : https://github.com/intel/media-driver/archive/intel-media-22.5.3/media-driver-22.5.3.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-22.5.3
cd %{_builddir}/media-driver-intel-media-22.5.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661354325
mkdir -p clr-build
pushd clr-build
