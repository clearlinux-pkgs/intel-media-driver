...
Version  : 24.4.1
Release  : 93
URL      : https://github.com/intel/media-driver/archive/intel-media-24.4.1/media-driver-24.4.1.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-24.4.1/media-driver-24.4.1.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-24.4.1
cd %{_builddir}/media-driver-intel-media-24.4.1
pushd ..
cp -a media-driver-intel-media-24.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729886883
mkdir -p clr-build
pushd clr-build
