...
Version  : 25.2.0
Release  : 102
URL      : https://github.com/intel/media-driver/archive/intel-media-25.2.0/media-driver-25.2.0.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-25.2.0/media-driver-25.2.0.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-25.2.0
cd %{_builddir}/media-driver-intel-media-25.2.0
pushd ..
cp -a media-driver-intel-media-25.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744304286
mkdir -p clr-build
pushd clr-build
