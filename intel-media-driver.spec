...
Version  : 23.3.5
Release  : 70
URL      : https://github.com/intel/media-driver/archive/intel-media-23.3.5/media-driver-23.3.5.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-23.3.5/media-driver-23.3.5.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-23.3.5
cd %{_builddir}/media-driver-intel-media-23.3.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697726212
mkdir -p clr-build
pushd clr-build
