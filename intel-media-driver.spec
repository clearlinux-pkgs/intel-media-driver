...
Version  : 25.1.0
Release  : 97
URL      : https://github.com/intel/media-driver/archive/intel-media-25.1.0/media-driver-25.1.0.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-25.1.0/media-driver-25.1.0.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-25.1.0
cd %{_builddir}/media-driver-intel-media-25.1.0
pushd ..
cp -a media-driver-intel-media-25.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736812056
mkdir -p clr-build
pushd clr-build
