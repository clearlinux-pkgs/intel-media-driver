...
Version  : 25.2.6
Release  : 106
URL      : https://github.com/intel/media-driver/archive/intel-media-25.2.6/media-driver-25.2.6.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-25.2.6/media-driver-25.2.6.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-25.2.6
cd %{_builddir}/media-driver-intel-media-25.2.6
pushd ..
cp -a media-driver-intel-media-25.2.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751382924
mkdir -p clr-build
pushd clr-build
