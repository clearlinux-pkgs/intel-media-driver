...
Version  : 24.4.2
Release  : 94
URL      : https://github.com/intel/media-driver/archive/intel-media-24.4.2/media-driver-24.4.2.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-24.4.2/media-driver-24.4.2.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-24.4.2
cd %{_builddir}/media-driver-intel-media-24.4.2
pushd ..
cp -a media-driver-intel-media-24.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730759578
mkdir -p clr-build
pushd clr-build
