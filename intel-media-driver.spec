...
Version  : 23.3.2
Release  : 67
URL      : https://github.com/intel/media-driver/archive/intel-media-23.3.2/media-driver-23.3.2.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-23.3.2/media-driver-23.3.2.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-23.3.2
cd %{_builddir}/media-driver-intel-media-23.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693248328
mkdir -p clr-build
pushd clr-build
