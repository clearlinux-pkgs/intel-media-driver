...
Version  : 25.1.1
Release  : 98
URL      : https://github.com/intel/media-driver/archive/intel-media-25.1.1/media-driver-25.1.1.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-25.1.1/media-driver-25.1.1.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-25.1.1
cd %{_builddir}/media-driver-intel-media-25.1.1
pushd ..
cp -a media-driver-intel-media-25.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738773345
mkdir -p clr-build
pushd clr-build
