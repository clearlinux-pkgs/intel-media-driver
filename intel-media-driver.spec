...
Version  : 22.1.1
Release  : 41
URL      : https://github.com/intel/media-driver/archive/intel-media-22.1.1/media-driver-22.1.1.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-22.1.1/media-driver-22.1.1.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-22.1.1
cd %{_builddir}/media-driver-intel-media-22.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642001410
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/media-driver-intel-media-22.1.1/LICENSE.md %{buildroot}/usr/share/package-licenses/intel-media-driver/0bf81514cc26fb24f29c2b53f3b972066f9cc758
cp %{_builddir}/media-driver-intel-media-22.1.1/media_driver/media_libvpx.LICENSE %{buildroot}/usr/share/package-licenses/intel-media-driver/4dbe7c1f3a1833a88333a7c282119323e9ef44fa
pushd clr-build
%make_install
popd
