...
Version  : 23.3.4
Release  : 69
URL      : https://github.com/intel/media-driver/archive/intel-media-23.3.4/media-driver-23.3.4.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-23.3.4/media-driver-23.3.4.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-23.3.4
cd %{_builddir}/media-driver-intel-media-23.3.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695913171
mkdir -p clr-build
pushd clr-build
