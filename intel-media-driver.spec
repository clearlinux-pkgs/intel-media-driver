...
Version  : 25.2.1
Release  : 103
URL      : https://github.com/intel/media-driver/archive/intel-media-25.2.1/media-driver-25.2.1.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-25.2.1/media-driver-25.2.1.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-25.2.1
cd %{_builddir}/media-driver-intel-media-25.2.1
pushd ..
cp -a media-driver-intel-media-25.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745335112
mkdir -p clr-build
pushd clr-build
