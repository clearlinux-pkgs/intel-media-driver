...
Version  : 22.6.4
Release  : 48
URL      : https://github.com/intel/media-driver/archive/intel-media-22.6.4/media-driver-22.6.4.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-22.6.4/media-driver-22.6.4.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-22.6.4
cd %{_builddir}/media-driver-intel-media-22.6.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672242272
mkdir -p clr-build
pushd clr-build
