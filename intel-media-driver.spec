...
Source0  : https://github.com/intel/media-driver/archive/intel-media-24.2.0/media-driver-24.2.0.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-24.2.0
cd %{_builddir}/media-driver-intel-media-24.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711723743
mkdir -p clr-build
pushd clr-build
