...
Source0  : https://github.com/intel/media-driver/archive/intel-media-24.4.3/media-driver-24.4.3.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-24.4.3
cd %{_builddir}/media-driver-intel-media-24.4.3
pushd ..
cp -a media-driver-intel-media-24.4.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732298861
mkdir -p clr-build
pushd clr-build
