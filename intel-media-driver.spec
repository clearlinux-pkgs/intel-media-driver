...
Version  : 24.1.2
Release  : 78
URL      : https://github.com/intel/media-driver/archive/intel-media-24.1.2/media-driver-24.1.2.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-24.1.2/media-driver-24.1.2.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-24.1.2
cd %{_builddir}/media-driver-intel-media-24.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706542918
mkdir -p clr-build
pushd clr-build
