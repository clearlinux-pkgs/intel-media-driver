...
Version  : 25.1.2
Release  : 99
URL      : https://github.com/intel/media-driver/archive/intel-media-25.1.2/media-driver-25.1.2.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-25.1.2/media-driver-25.1.2.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-25.1.2
cd %{_builddir}/media-driver-intel-media-25.1.2
pushd ..
cp -a media-driver-intel-media-25.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739824556
mkdir -p clr-build
pushd clr-build
