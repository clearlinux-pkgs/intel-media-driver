...
Version  : 22.6.6
Release  : 51
URL      : https://github.com/intel/media-driver/archive/intel-media-22.6.6/media-driver-22.6.6.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-22.6.6/media-driver-22.6.6.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-22.6.6
cd %{_builddir}/media-driver-intel-media-22.6.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673016174
mkdir -p clr-build
pushd clr-build
