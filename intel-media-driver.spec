...
Source0  : https://github.com/intel/media-driver/archive/intel-media-24.3.0/media-driver-24.3.0.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-24.3.0
cd %{_builddir}/media-driver-intel-media-24.3.0
pushd ..
cp -a media-driver-intel-media-24.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721658558
mkdir -p clr-build
pushd clr-build
