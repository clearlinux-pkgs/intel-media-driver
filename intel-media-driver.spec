...
Version  : 22.6.1
Release  : 47
URL      : https://github.com/intel/media-driver/archive/intel-media-22.6.1/media-driver-22.6.1.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-22.6.1/media-driver-22.6.1.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-22.6.1
cd %{_builddir}/media-driver-intel-media-22.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667397233
mkdir -p clr-build
pushd clr-build
