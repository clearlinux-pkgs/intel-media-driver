...
Source0  : https://github.com/intel/media-driver/archive/intel-media-24.1.5/media-driver-24.1.5.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-24.1.5
cd %{_builddir}/media-driver-intel-media-24.1.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710944000
mkdir -p clr-build
pushd clr-build
