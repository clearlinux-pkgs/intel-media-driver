...
Version  : 25.1.4
Release  : 101
URL      : https://github.com/intel/media-driver/archive/intel-media-25.1.4/media-driver-25.1.4.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-25.1.4/media-driver-25.1.4.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-25.1.4
cd %{_builddir}/media-driver-intel-media-25.1.4
pushd ..
cp -a media-driver-intel-media-25.1.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742835206
mkdir -p clr-build
pushd clr-build
