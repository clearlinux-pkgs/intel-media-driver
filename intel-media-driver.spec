...
Source0  : https://github.com/intel/media-driver/archive/intel-media-24.4.4/media-driver-24.4.4.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-24.4.4
cd %{_builddir}/media-driver-intel-media-24.4.4
pushd ..
cp -a media-driver-intel-media-24.4.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733833434
mkdir -p clr-build
pushd clr-build
