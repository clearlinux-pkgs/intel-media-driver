...
Version  : 25.2.3
Release  : 104
URL      : https://github.com/intel/media-driver/archive/intel-media-25.2.3/media-driver-25.2.3.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-25.2.3/media-driver-25.2.3.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-25.2.3
cd %{_builddir}/media-driver-intel-media-25.2.3
pushd ..
cp -a media-driver-intel-media-25.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748368753
mkdir -p clr-build
pushd clr-build
