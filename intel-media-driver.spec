...
Source0  : https://github.com/intel/media-driver/archive/intel-media-23.1.1/media-driver-23.1.1.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-23.1.1
cd %{_builddir}/media-driver-intel-media-23.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675783323
mkdir -p clr-build
pushd clr-build
