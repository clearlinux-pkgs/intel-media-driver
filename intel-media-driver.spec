...
Version  : 21.3.0
Release  : 30
URL      : https://github.com/intel/media-driver/archive/intel-media-21.3.0/media-driver-21.3.0.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-21.3.0/media-driver-21.3.0.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-21.3.0
cd %{_builddir}/media-driver-intel-media-21.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627050366
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/media-driver-intel-media-21.3.0/LICENSE.md %{buildroot}/usr/share/package-licenses/intel-media-driver/0bf81514cc26fb24f29c2b53f3b972066f9cc758
cp %{_builddir}/media-driver-intel-media-21.3.0/media_driver/media_libvpx.LICENSE %{buildroot}/usr/share/package-licenses/intel-media-driver/4dbe7c1f3a1833a88333a7c282119323e9ef44fa
pushd clr-build
%make_install
popd
