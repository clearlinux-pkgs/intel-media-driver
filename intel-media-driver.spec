...
Version  : 23.1.4
Release  : 56
URL      : https://github.com/intel/media-driver/archive/intel-media-23.1.4/media-driver-23.1.4.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-23.1.4/media-driver-23.1.4.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-23.1.4
cd %{_builddir}/media-driver-intel-media-23.1.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679409306
mkdir -p clr-build
pushd clr-build
