...
Version  : 23.4.0
Release  : 71
URL      : https://github.com/intel/media-driver/archive/intel-media-23.4.0/media-driver-23.4.0.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-23.4.0/media-driver-23.4.0.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-23.4.0
cd %{_builddir}/media-driver-intel-media-23.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698416872
mkdir -p clr-build
pushd clr-build
