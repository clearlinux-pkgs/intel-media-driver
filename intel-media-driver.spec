...
Version  : 24.2.1
Release  : 83
URL      : https://github.com/intel/media-driver/archive/intel-media-24.2.1/media-driver-24.2.1.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-24.2.1/media-driver-24.2.1.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-24.2.1
cd %{_builddir}/media-driver-intel-media-24.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713280652
mkdir -p clr-build
pushd clr-build
