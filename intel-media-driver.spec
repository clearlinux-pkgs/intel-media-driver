...
Version  : 24.3.4
Release  : 91
URL      : https://github.com/intel/media-driver/archive/intel-media-24.3.4/media-driver-24.3.4.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-24.3.4/media-driver-24.3.4.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-24.3.4
cd %{_builddir}/media-driver-intel-media-24.3.4
pushd ..
cp -a media-driver-intel-media-24.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726762354
mkdir -p clr-build
pushd clr-build
