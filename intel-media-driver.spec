...
Source0  : https://github.com/intel/media-driver/archive/intel-media-23.3.1/media-driver-23.3.1.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-23.3.1
cd %{_builddir}/media-driver-intel-media-23.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1691425554
mkdir -p clr-build
pushd clr-build
