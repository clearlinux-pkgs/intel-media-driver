...
Version  : 24.2.2
Release  : 84
URL      : https://github.com/intel/media-driver/archive/intel-media-24.2.2/media-driver-24.2.2.tar.gz
Source0  : https://github.com/intel/media-driver/archive/intel-media-24.2.2/media-driver-24.2.2.tar.gz
...
%prep
%setup -q -n media-driver-intel-media-24.2.2
cd %{_builddir}/media-driver-intel-media-24.2.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714491673
mkdir -p clr-build
pushd clr-build
